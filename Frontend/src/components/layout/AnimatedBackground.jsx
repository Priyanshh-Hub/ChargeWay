  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      ...
      <div className="absolute inset-0 cw-bg-gradient-move"
        style={{ backgroundImage: "linear-gradient(120deg, rgba(91,71,224,0.08), rgba(255,138,61,0.05), rgba(100,0,255,0.06))", backgroundSize: "200% 200%" }} />

      {/* Layer 2: soft pulsing glows */}
      <div className="absolute w-[36rem] h-[36rem] rounded-full blur-3xl cw-glow-a"
        style={{ left: "10%", top: "65%", background: "radial-gradient(circle, rgba(255,138,61,0.10), transparent 70%)" }} />
      ...
      {particles.map(p => (
        <span key={p.id} className="absolute rounded-full bg-[#FFAB70] cw-particle"
          style={{
