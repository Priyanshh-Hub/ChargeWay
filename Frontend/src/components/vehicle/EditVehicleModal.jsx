      ...
      <form onSubmit={submit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            ...
            <span className="text-sm font-bold text-[#FF8A3D]">{batteryHealth}%</span>
          </div>
          <input type="range" min="1" max="100" value={batteryHealth} onChange={e => setBatteryHealth(e.target.value)} className="w-full accent-[#FF8A3D]" />
        </div>
